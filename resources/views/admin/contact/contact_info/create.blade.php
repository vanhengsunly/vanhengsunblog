                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="address_map_link" name="address_map_link"  class="form-control" placeholder="{{ __('content.enter_address_map_link') }}">{{ $contact->address_map_link }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-12">
                            ...
                            <form  action="{{ route('contact.store') }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="address_map_link">{{ __('content.address_map_link') }}</label>
                                            <textarea id="address_map_link" name="address_map_link"  class="form-control" placeholder="{{ __('content.address_map_link') }}"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-success">
