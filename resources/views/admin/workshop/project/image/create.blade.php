                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input id="link" type="text" name="link" class="form-control" value="{{ $project_image->link }}" placeholder="{{ __('content.enter_link') }}">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="project_image" name="project_image" type="file" class="form-control-file" required>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
