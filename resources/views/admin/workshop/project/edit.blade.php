                    ...
                    <div class="card-body">
                        <form  action="{{ route('project.update', $project->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="short_desc">{{ __('content.short_desc') }} ({{ __('content.max') }} {{ __('content.40_character') }}) </label>
                                        <input id="short_desc" type="text" name="short_desc" class="form-control"  value="{{ $project->short_desc }}" placeholder="{{ __('content.enter_short_desc') }}">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="project_bg_image">{{ __('content.bg_image') }} ({{ __('content.size') }} 895x552)(.png, .jpg, .jpeg)</label>
                                        <input id="project_bg_image" name="project_bg_image" type="file" class="form-control-file">
                                        ...
                                        <div class="card custom-card margin-top-20">
                                            ...
                                            <div class="card-body">
                                                @if (!empty($project->project_bg_image))
                                                    <img src="{{ asset('uploads/img/project/bg/'.$project->project_bg_image) }}" class="mg-thumbnail mx-auto d-block w-25" alt="project image">
                                                @else
