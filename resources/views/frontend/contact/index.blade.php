                   ...
                   @if (!empty($contact->phone_title) || !empty($contact->phone))
                    ...
                    @if (!empty($contact->address_title) || !empty($contact->address))
                        <p class="open-sans-font custom-span-contact position-relative">
                            ...
                            <span class="d-block">{{ $contact->address_title }}</span><a class="@if($homepage_version->choose_version == 1) custom-text-light @else text-white @endif" href="{{ $contact->address_map_link }}" target="_blank">{{ $contact->address }}</a>
                        </p>
                    @endif
