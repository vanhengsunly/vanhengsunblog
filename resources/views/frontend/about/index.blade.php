                    ...
                    <div class="col-12 col-lg-5 col-xl-6">
                        <div class="row">
                            ...
                            @else
                                ...
                                <div class="col-12 d-block d-sm-none">
                                    <img src="{{  asset('uploads/img/dummy/300x300.png') }}" class="img-fluid main-img-mobile" alt="my picture" />
                                </div>
                                <div class="col-6">
                                    <ul class="about-list list-unstyled open-sans-font">
                                ...
                                @if (!empty($skill->desc))
                                    <div class="row">
                                        <div class="col-md-8 mx-auto">
                                            <p class="open-sans-font mb-5 text-center custom-text-left">{{ $skill->desc }}</p>
                                        </div>
                                    </div>
                                @endif
                            </div>
                    ...
                    @if (isset($education))
                        <div class="col-12">
                            ...
                            @if (!empty($education->desc))
                                <div class="row">
                                    <div class="col-md-8 mx-auto">
                                        <p class="open-sans-font mb-5 text-center custom-text-left">{{ $education->desc }}</p>
                                    </div>
                                </div>
                            @endif
                        </div>
