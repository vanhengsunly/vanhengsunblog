                ...
                <section class="grid-wrap">
                            ...
                            <li>
                                <figure>
                                  @if (!empty($project->project_bg_image))
                                        <img src="{{ asset('uploads/img/project/bg/'.$project->project_bg_image) }}" alt="Portolio Image" />
                                      @else
                                        <img src="{{ asset('uploads/img/dummy/portfolio.jpg') }}" alt="Portolio Image" />
                                      @endif
                                    <div>
                                        <span>{{ $project->project_name }}</span>
                                        <span class="position-absolute portfolio-short-desc text-capitalize">{{ $project->short_desc }}</span>
                                    </div>
                                </figure>
                            </li>
                    @endforeach
                    <!-- Portfolio Item Ends -->
                        <li  style="visibility: hidden;">
                            <figure>
                                <img src="{{ asset('uploads/img/dummy/895x552.jpg') }}" alt="Portolio Image" />
                                ...
                                <figure>
                                    ...
                                    @if ($project->project_view_option == 1)
                                        @if (isset($project->image))
                                            <a href="@if (!empty($project->image->link)) {{ $project->image->link }} @else # @endif"><img src="{{ asset('uploads/img/project/'.$project->image->project_image) }}" class="img-fluid" alt="Portolio Image" /></a>
                                        @endif
                    ...
                    <ul>
                        ...
                        <li>
                            <figure>
                                ...
                                <!-- Project Details Ends -->
                                <!-- Main Project Content Starts -->
                                <video id="video" class="responsive-video" controls poster="{{ asset('uploads/img/dummy/895x552.jpg') }}">
                                    <source src="path_to_your_video" type="video/mp4">
                                </video>
                                <!-- Main Project Content Ends -->
                            </figure>
